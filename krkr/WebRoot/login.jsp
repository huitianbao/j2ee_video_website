...
<div id="wrapper_sec">
    ...
    <div id="masthead">
 	...
 	<div id="iframe">
		<center><form method="post" action="/krkr/servlet/LoginServlet" method="get">
			<p id="pp"><span>用户名：</span><input type="text" name="username"  /></p>
			<p><span>密码：</span><input type="text" name="password"  /></p>
			<p><input type="submit" value="登录" class="inputFloat" /></p>
